...
*/
			...
			if(src.StrTax)
				src.SubStrTax(0.25/(1 DAYS))
			if(src.EndTax)
				src.SubEndTax(0.25/(1 DAYS))
			if(src.SpdTax)
				src.SubSpdTax(0.25/(1 DAYS))
			if(src.ForTax)
				src.SubForTax(0.25/(1 DAYS))
			if(src.OffTax)
				src.SubOffTax(0.25/(1 DAYS))
			if(src.DefTax)
				src.SubDefTax(0.25/(1 DAYS))
			if(src.RecovTax)
				src.SubRecovTax(0.25/(1 DAYS))
