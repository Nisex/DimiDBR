			...
			NuStyle
				...
				UnarmedStyle
					...
					Moonlit_Lake_Style
						...
						passives = list("SpiritFlow" = 1, "SpiritHand" = 4)
						NoStaff = 0
						SpiritFlow=1
						SpiritHand=1
						ElementalOffense="Water"
					...
					Entropy_Style
						...
						passives = list("CyberStigma" = 4, "PureReduction" = 2, "PureDamage" = 2)
						CyberStigma=2
					...
					Devil_Leg_Style
						...
						StyleStr=1.5
						StyleFor=1.5
						passives = list("SpiritHand" = 4, "DarknessFlame" = 1, "PureDamage" = 2)
						SpiritHand=1
						DarknessFlame=1
					...
					Phage_Style
						...
						Copyable=0
						StyleSpd=2
						passives = list("CounterMaster" = 2, "PureDamage" = 2, "VoidField" = 4, "DeathField" = 4)
						CounterMaster=2
						VoidField=2
						DeathField=2
						NoStaff = 0
