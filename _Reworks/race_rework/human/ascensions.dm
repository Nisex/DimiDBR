ascension
	human
		...
		three
			...
			passives = list("Desperation" = 1.5, "Underdog" = 1, "TechniqueMastery" = 1, "DemonicDurability" = 0.5)
			strength = 0.25
			endurance = 0.25
			force = 0.25
			offense = 0.25
		...
		five
			...
			passives = list("Desperation" = 1.5, "TechniqueMastery" = -1, "DemonicDurability" = 0.5)
			strength = 1
			endurance = 1
			force = 1
			offense = 1
