						...
						if(Clashable || Secret == "Heavenly Restriction" && secretDatum?:hasImprovement("Dragon Dash"))
							for(var/obj/Skills/Buffs/SlotlessBuffs/Autonomous/Dragon_Clash_Defensive/DC in Trg)
								if(!Trg.BuffOn(DC))
									...
									if(Trg.Secret == "Heavenly Restriction" && Trg.secretDatum?:hasImprovement("Dragon Clash"))
										DC.passives["PureDamage"] += Trg.secretDatum?:getBoon(Trg, "Dragon Clash")
										DC.KenWave = Trg.secretDatum?:getBoon(Trg, "Dragon Clash")
										pursuerBoon += Trg.secretDatum?:getBoon(Trg, "Dragon Clash")
							...
							for(var/obj/Skills/Buffs/SlotlessBuffs/Autonomous/Dragon_Clash/DC in src)
								if(!src.BuffOn(DC))
									...
									if(Secret == "Heavenly Restriction" && secretDatum?:hasImprovement("Dragon Clash"))
										DC.passives["KBAdd"] = secretDatum?:getBoon(src, "Dragon Clash")
										DC.passives["KBMult"] = clamp(1, secretDatum?:getBoon(src, "Dragon Clash")/2, 2)
										DC.passives["PureDamage"] += secretDatum?:getBoon(src, "Dragon Clash")
										DC.KenWave = secretDatum?:getBoon(src, "Dragon Clash")
										pursuerBoon += secretDatum?:getBoon(src, "Dragon Clash")
									DC.TimerLimit = 3 + clamp(pursuerBoon, 1, 3)
									DC.Trigger(src)
					break
				else
